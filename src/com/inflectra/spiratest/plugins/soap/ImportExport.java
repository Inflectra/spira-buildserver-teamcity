    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.inflectra.spiratest.plugins.soap.ImportExport.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.inflectra.spiratest.plugins.soap.ImportExport.class.getResource(".");
            url = new URL(baseUrl, "http://localhost/Spira/Services/v3_0/ImportExport.svc?WSDL");
